export function ContactForm() {
  return (
    <form className="rounded-4xl border border-brand-line bg-white p-8 shadow-premium">
      ...
      <input
        className="mt-5 w-full rounded-2xl border border-brand-line px-4 py-3 text-sm outline-none transition focus:border-brand-blue"
        type="tel"
        placeholder="Phone number"
      />
      <textarea
        className="mt-5 min-h-40 w-full rounded-2xl border border-brand-line px-4 py-3 text-sm outline-none transition focus:border-brand-blue"
